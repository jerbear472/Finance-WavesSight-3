  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900/20 to-black">
      <div className="container mx-auto px-4 py-6 max-w-6xl safe-area-top safe-area-bottom">
        ...
        {/* Enhanced Earnings & Gamification Overview */}
        <motion.div
        ...
        >
          ...
          <button
            ...
            className="bg-purple-500/20 backdrop-blur-sm rounded-xl p-4 border border-purple-500/30 hover:bg-purple-500/30 transition-all text-left group"
          >
            <p className="text-xs text-purple-300 font-medium flex items-center gap-1">
              Daily Challenges <Target className="w-3 h-3" />
            </p>
            <p className="text-2xl font-bold text-purple-400 group-hover:scale-105 transition-transform">View</p>
          </button>
          <button
            onClick={() => setShowAchievements(true)}
            className="bg-orange-500/20 backdrop-blur-sm rounded-xl p-4 border border-orange-500/30 hover:bg-orange-500/30 transition-all text-left group"
          >
            <p className="text-xs text-orange-300 font-medium flex items-center gap-1">
              Achievements <Trophy className="w-3 h-3" />
            </p>
            <p className="text-2xl font-bold text-orange-400 group-hover:scale-105 transition-transform">Check</p>
          </button>
        </motion.div>
